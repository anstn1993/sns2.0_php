...
$myAccount = $_POST['account'];//로그인한 사용자 account
$list_size = (int)$_POST['listSize'];//한 번 로드될 때 보여줄 데이터 수
$start_index = (int)$_POST['lastId'];//리스트의 시작 index
